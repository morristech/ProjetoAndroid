...
public class novoPerdidoActivity extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    private static final String TAG = "novoPerdidoActivity";
    LatLng coordinates;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.amand.projetointegrador.R.layout.activity_novo_perdido);
